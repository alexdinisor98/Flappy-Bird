...
void Tema1_Vis2D::Init()
{
	...
	Mesh* square1 = Object2D_T1::CreateBird("square1", corner, length, glm::vec3(1, 0, 0));
...
void Tema1_Vis2D::DrawScene(glm::mat3 visMatrix)
{
	...
	modelMatrix = visMatrix * Transform2D_T1::Translate(3, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D_T1::Translate(1.5, 1.5);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D_T1::Translate(0, 3);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * Transform2D_T1::Translate(3, 3);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);
}
